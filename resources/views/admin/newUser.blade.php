...
<div class="card col-12 col-lg-6 col-xl-4 mb-3 pb-5 mx-auto">
    <div class="card-body">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h4 class="card-title card-headline text-capitalize">add new user</h4>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 mt-3">
                        ...
                        <select name="role" id="role" required class="form-control rounded-pill">
                            ...
                            <option {{ (old('role') != '1') ? 'selected' : '' }} value="2">User</option>
                        </select>
                        <p class="text-danger mb-0">
                            @error('role')
                            {{ $message }}
                    ...
                    <div class="col-12 mt-3">
                        ...
                        <input name="password" id="password" type="password" required class="form-control rounded-pill">
                        <p class="text-danger mb-0">
                            @error('password')
                            {{ $message }}
                            @enderror
                    ...
                    <div class="col-12 mt-5">
                        <button name="submit" class="btn btn-primary w-100 rounded-pill" type="submit"><span
                                data-feather="plus"></span> Add User</button>
                    </div>
                </div>
